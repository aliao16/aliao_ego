...
export default {
  ...
  data() {
    return {
      ...
      type: 1,
      list: [],
      dialogVisible: false,//弹框，默认不显示，用了ref以后这句不需要
  ...
  methods: {
    ...
    changeDialog() {
      // 接收子组件GoodsDialog传来的自定义事件，更改弹框显示状态为关闭
